...
def main():
    ...
    high_scorers = [
        player["name"] for player in player_scores if player["score"] > 2000
    ]
    ...
    active_players = [
        player["name"] for player in player_scores if player["active"]
    ]
    ...
    player_score_map = {
        player["name"]: player["score"] for player in player_scores
    }
    ...
    score_categories = {
        ...
        "medium": len(
            [p for p in player_scores if 1800 <= p["score"] <= 2000]
        ),
    ...
    unique_achievements = set(all_achievements_list)
    print(f"Unique achievements: {unique_achievements}")

    active_regions = {
        player["region"] for player in player_scores if player["active"]
    }
